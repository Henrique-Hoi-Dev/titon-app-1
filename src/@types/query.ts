...
export type ClientQueriesMutationsSchema = z.infer<
  typeof clientQueriesMutationsSchema
>
...
export type SqliteSuccessResultSchema = z.infer<
  typeof sqliteSuccessResultSchema
>
